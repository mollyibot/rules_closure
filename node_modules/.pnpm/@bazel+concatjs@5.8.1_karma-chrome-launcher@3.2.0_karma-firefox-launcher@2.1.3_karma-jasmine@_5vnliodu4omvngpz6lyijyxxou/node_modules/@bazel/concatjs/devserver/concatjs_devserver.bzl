...
concatjs_devserver = rule(
    ...
    attrs = {
        ...
        "devserver": attr.label(
            ...
            default = Label("//@bazel/concatjs/devserver"),
            executable = True,
            cfg = "exec",
        ),
        ...
        "_launcher_template": attr.label(allow_single_file = True, default = Label("//@bazel/concatjs/devserver:launcher_template.sh")),
        "_requirejs_script": attr.label(allow_single_file = True, default = Label("//@bazel/concatjs/third_party/npm/requirejs:require.js")),
    },
    outputs = {
        "manifest": "%{name}.MF",
        "script": "%{name}.sh",
