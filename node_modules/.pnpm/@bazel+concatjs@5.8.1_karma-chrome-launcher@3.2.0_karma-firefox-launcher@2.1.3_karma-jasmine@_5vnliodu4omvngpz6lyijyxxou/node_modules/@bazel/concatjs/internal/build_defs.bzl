...
load("//@bazel/concatjs/internal:common/compilation.bzl", "COMMON_ATTRIBUTES", "DEPS_ASPECTS", "compile_ts", "ts_providers_dict_to_struct")
load("//@bazel/concatjs/internal:common/tsconfig.bzl", "create_tsconfig")
load("//@bazel/concatjs/internal:ts_config.bzl", "TsConfigInfo")
