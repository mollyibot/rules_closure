 ...
 */
export declare function gatherDiagnostics(options: ts.CompilerOptions, bazelOpts: BazelOptions, program: ts.Program, disabledTsetseRules: string[], plugins?: DiagnosticPlugin[], ignoreForDiagnostics?: Set<ts.SourceFile>): ts.Diagnostic[];
/**
 ...
 */
export declare function createProgramAndEmit(fileLoader: FileLoader, options: ts.CompilerOptions, bazelOpts: BazelOptions, files: string[], disabledTsetseRules: string[]): Promise<{
    program?: ts.Program;
