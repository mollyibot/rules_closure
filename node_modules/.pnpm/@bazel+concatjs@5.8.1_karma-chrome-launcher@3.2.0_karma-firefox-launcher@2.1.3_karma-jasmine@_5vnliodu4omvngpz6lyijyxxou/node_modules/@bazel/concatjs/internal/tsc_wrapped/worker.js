...
function loadWorkerPb() {
    ...
    if (!protofile) {
        ...
        if (runfiles) {
            protofile = require(runfiles).resolve('build_bazel_rules_nodejs/packages/concatjs/third_party/github.com/bazelbuild/bazel/src/main/protobuf/worker_protocol.proto');
        }
        if (!protofile) {
                ...
                try {
                    ...
                    while (reader.len - reader.pos > 0) {
                        ...
                        process.stdout.write(workerpb.WorkResponse.encodeDelimited({
                            exitCode: (yield runOneBuild(args, inputs)) ? 0 : 1,
