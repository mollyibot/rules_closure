...
load("@rules_nodejs//nodejs/private:ts_config.bzl", "write_tsconfig", _TsConfigInfo = "TsConfigInfo", _ts_config = "ts_config")
load("@rules_nodejs//nodejs/private:ts_project.bzl", _ts_project_lib = "ts_project")
load("@rules_nodejs//nodejs/private:ts_lib.bzl", "DEPS_PROVIDERS", _lib = "lib")
    ...
    if type(tsconfig) == type(dict()):
        ...
        if validate:
            validate_options(
                ...
                validator = Label("//@bazel/typescript/bin:ts_project_options_validator"),
                **common_kwargs
            )
